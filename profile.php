                        ...
                        <div class="card-body p-4">
                            ...
                            <?php
                                if(isset($_POST['update_profile'])){
                                    ...
                                    $update = mysqli_query($conn, "UPDATE users SET name='$name', username='$username', phone='$phone' WHERE id='$admin->id'");
                        ...
                        <div class="card-body p-4">
                            ...
                            <?php 
                                if(isset($_POST['update_password'])){
                                    ...
                                    $check = mysqli_query($conn, "SELECT * FROM users WHERE id = '$admin->id' AND password = '" . MD5($current_password) . "'");
                                    if(mysqli_num_rows($check) > 0){
                                        if(empty($new_password)){
                                            ...
                                            $update_pw = mysqli_query($conn, "UPDATE users SET password='" . MD5($new_password) . "' WHERE id='$admin->id'");
                                            if($update_pw){
                                                echo '<div class="alert alert-success alert-dismissible fade show" role="alert">
